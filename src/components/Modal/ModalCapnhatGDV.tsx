...
// import { CalendarDateValue, CalendarTime } from "../Calendar/CalendarDateValue";
...
//     const [, setData] = useState<datafirebase[]>([]);
...
//         <Button danger onClick={() => setModal1Open(false)} 
//         style={{ width: '160px', 
//             height: '40px', 
